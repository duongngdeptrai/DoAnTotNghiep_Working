...
Khi backend phát hiện vi phạm geofence hoặc nhận tín hiệu SOS, hệ thống kích hoạt \textbf{ba kênh thông báo song song}, không phụ thuộc nhau:
...
\begin{enumerate}
    ...
    \item \textbf{Email:} Backend gửi email cảnh báo qua SMTP đến địa chỉ email đã đăng ký của phụ huynh. Kênh này là lớp dự phòng cuối cùng, đảm bảo phụ huynh có bằng chứng ghi nhận và có thể tra cứu lại lịch sử cảnh báo ngay cả khi không nhận được hai kênh trên.
\end{enumerate}
