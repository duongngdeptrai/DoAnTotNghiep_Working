...
Về phần cứng, vi điều khiển ESP32 được chọn làm đơn vị xử lý trung tâm nhờ hiệu năng cao, hỗ trợ kết nối không dây tích hợp và chế độ ngủ sâu tiêu thụ điện thấp (deep sleep, ~10\,µA). Module SIM7000G tích hợp đồng thời bộ thu GPS và modem di động (NB-IoT/GPRS) trong một linh kiện duy nhất, giúp giảm thiểu số lượng linh kiện và đơn giản hóa firmware so với việc sử dụng hai module riêng biệt.
...
Đóng góp chính của đề tài là một nguyên mẫu hệ thống IoT theo dõi vị trí hoàn chỉnh, hoạt động độc lập không cần điện thoại của trẻ, với độ trễ end-to-end dưới 2 giây, độ chính xác GPS khoảng 3.2\,m và thời lượng pin trên 9 giờ ở chu kỳ cập nhật 5 giây.
...
Chương 5 tập trung trình bày các giải pháp kỹ thuật và đóng góp nổi bật của đề tài, gồm thiết kế tích hợp phần cứng một module, thuật toán geofencing Haversine, kiến trúc truyền thông lai MQTT–WebSocket và chiến lược quản lý năng lượng thiết bị nhúng.
